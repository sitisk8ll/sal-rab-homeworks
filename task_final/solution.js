...
//    }
// } 
// Внутри цикла вы должны добавить не только заголовок продукта, а сформировать объект из свойств title и count. Посмотрите,
// у вас есть обращение к названию продукта goods[i].title, это значение вы должны сделать
// в свойстве title, аналогично и для свойства count. В массив пушить этот формируемый объект.
